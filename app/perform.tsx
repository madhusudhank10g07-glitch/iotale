  ...
  return (
    <BackgroundPage backgroundSource={require('../assets/images/bg/diynumber.png')}>
      ...
      <View style={styles.bottomBar}>
        ...
        {/* Right: Stop + icon buttons */}
        <View style={styles.iconGroup}>
          {/* Stop button repurposed as the first icon slot */}
          <TouchableOpacity
            onPress={handleStop}
...
const styles = StyleSheet.create({
  ...
  // ── Bottom Tool Bar (from web version) ────────────────────────────────────
  bottomBar: {
    ...
    marginHorizontal: 16,
    marginBottom: 44,
    // 3D drop-shadow matching the web version's box-shadow: 0 8px 0px #085590
    shadowColor: '#085590',
    shadowOffset: { width: 0, height: 8 },
    shadowOpacity: 1,
    shadowRadius: 0,
